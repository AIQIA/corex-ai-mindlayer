...
function activate(context) {
    ...
    context.subscriptions.push(createAiJsonCommand, validateSchemaCommand, runScannerCommand, architecturePreviewCommand, treeExplorerCommand, aiIntelliSenseCommand, mindMapCommand, autoDocsCommand, diffAnalyzerCommand, autoSyncCommand, updateFromPackageCommand, scanDockerConfigCommand, aiJsonWatcher);
}
