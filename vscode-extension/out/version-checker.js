...
class VersionChecker {
    ...
    async installUpdate(version) {
        ...
        vscode.window.withProgress({
            ...
            try {
                ...
                vscode.window.showInformationMessage('🎉 Update erfolgreich installiert! VS Code muss neu gestartet werden.', 'Jetzt neu starten').then(selection => {
                ...
                vscode.window.showErrorMessage('Fehler bei der Update-Installation. Rollback wird durchgeführt...', 'Details anzeigen').then(selection => {
    ...
    async downloadVsix(version) {
        // TODO: Implementierung zum Herunterladen der VSIX-Datei
        ...
        // Hier würde der tatsächliche Download-Code stehen
        // Für den Prototypen geben wir einfach den Pfad zurück
        return vsixPath;
    }
    /**
